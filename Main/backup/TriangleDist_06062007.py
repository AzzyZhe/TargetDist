...
def get_matched_features_and_pose(image1, image2, cameraMatrix):
...
if __name__ == '__main__':
    ...
    point_seq = 5
    frame_seq = 5
    debug_device = R"E:\Project\AdvProj_UAVVision\MyCode\myPic\vid3-cars.mp4"
    ...
    try:
        while True:
            ...
            points, rotation_vector, translation_vector = get_matched_features_and_pose(last_frame, now_frame, K)
            if points is None:
                print('Failed!')
                continue
            # print(f'{points=}')
